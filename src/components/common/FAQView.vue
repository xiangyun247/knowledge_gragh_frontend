      ...
      this.faqs = [
        {
          ...
          answer: '医疗知识图谱系统是基于人工智能的医疗知识网络：将医疗数据结构化存储，支持 28 种实体类型（如疾病、症状、药物、检查、解剖部位等）和 21 种关系类型（如症状或体征、用于治疗、并发症等）；通过图谱可视化展示实体关系；支持自然语言问答、实体搜索、数据上传与知识库入库、批量构建图谱等。系统提供「科技风」和「医疗风」两种主题，历史记录支持分页与最多 1000 条，便于日常使用与追溯。',
