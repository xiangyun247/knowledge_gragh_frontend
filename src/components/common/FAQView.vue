    ...
    generateMockData() {
      ...
      this.faqs = [
        ...
        },
        {
          ...
          answer: '患者教育中心是专门为临床医生和科普运营设计的模块，可一键生成面向患者的「疾病说明书」。您只需输入一个主题（例如「急性胰腺炎出院后注意事项」），系统会基于知识图谱和文献自动生成结构化的患者教育内容，包括标题、分节小结（病情简介、注意事项、饮食建议、复查与随访等）以及结尾的温馨提示，方便直接打印或发送给患者。',
